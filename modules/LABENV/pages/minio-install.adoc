...
image::minio_install.gif[width=600]
 ...
 .  In the new window, we will paste the following YAML file.  In the YAML below it's recommended to change the default user name & password. 
...
From the OCP Dashboard:
 ...
 . For the first step, select the UI route and paste it or open it in a new browser tab or window.
