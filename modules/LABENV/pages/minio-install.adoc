...
+
//image::minio_yaml_deploy.png[width=640]
...
//+
//image::minio_routes.png[width=640]
...
This completes the pre-work to configure the data scicence pipeline lab environment. With our S3 Compatible storage ready to go, let's head to next section of the course and learn about DSP concepts.